...
import 'package:main_store/View/Componants/CrouselWidget/Crousel_Widget.dart';
...
class SnapShotCarousel {
  ...
  static Widget snapShotCarousel(
      ...
      /// Defaults to orange.
      Color selectedImageBorderColor = accentColor,
      ...
      /// Defaults to 2.
      double unselectedImageBorderWidth = 0,
      ...
      /// Defaults to 0.
      double featureImageBorderRadius = 5,
